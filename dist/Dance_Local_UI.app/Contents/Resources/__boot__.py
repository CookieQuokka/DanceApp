...
_recipes_pil_prescript(['ImtImagePlugin', 'IptcImagePlugin', 'XVThumbImagePlugin', 'CurImagePlugin', 'PpmImagePlugin', 'MpegImagePlugin', 'PalmImagePlugin', 'IcoImagePlugin', 'WmfImagePlugin', 'XpmImagePlugin', 'WebPImagePlugin', 'PngImagePlugin', 'TiffImagePlugin', 'GribStubImagePlugin', 'Hdf5StubImagePlugin', 'PsdImagePlugin', 'PdfImagePlugin', 'FtexImagePlugin', 'MspImagePlugin', 'PixarImagePlugin', 'SpiderImagePlugin', 'BufrStubImagePlugin', 'PcxImagePlugin', 'FitsStubImagePlugin', 'BmpImagePlugin', 'McIdasImagePlugin', 'SgiImagePlugin', 'DcxImagePlugin', 'MicImagePlugin', 'BlpImagePlugin', 'FliImagePlugin', 'PcdImagePlugin', 'TgaImagePlugin', 'IcnsImagePlugin', 'GifImagePlugin', 'FpxImagePlugin', 'GbrImagePlugin', 'XbmImagePlugin', 'MpoImagePlugin', 'ImImagePlugin', 'JpegImagePlugin', 'SunImagePlugin', 'EpsImagePlugin', 'Jpeg2KImagePlugin', 'DdsImagePlugin'])
...
DEFAULT_SCRIPT='Dance_Local_UI.py'
SCRIPT_MAP={}
_run()
